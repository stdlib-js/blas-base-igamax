...
```javascript
import igamax from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-igamax@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-igamax@v0.1.1-deno/mod.js';
```
